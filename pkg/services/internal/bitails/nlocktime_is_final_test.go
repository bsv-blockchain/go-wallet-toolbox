// pkg/services/internal/bitails/nlocktime_is_final_test.go
...
func TestBitails_NLockTimeIsFinal_LockHeightComparisons(t *testing.T) {
	// given:
	const chainHeight = uint32(700_000)

	given := bt.Given(t)
	given.Bitails().WillReturnNetworkInfo(http.StatusOK, chainHeight)
...
func TestBitails_NLockTimeIsFinal_TimestampComparisons(t *testing.T) {
	// given:
	given := bt.Given(t)
	svc := given.NewBitailsService()
...
func TestBitails_NLockTimeIsFinal_Tx_AllInputsFinalShortCircuit(t *testing.T) {
	// given:
	given := bt.Given(t)
	svc := given.NewBitailsService()
...
func TestBitails_NLockTimeIsFinal_Tx_HeightPath(t *testing.T) {
	// given:
...
func TestBitails_NLockTimeIsFinal_PropagatesCurrentHeightErrors(t *testing.T) {
	// given:
	given := bt.Given(t)
