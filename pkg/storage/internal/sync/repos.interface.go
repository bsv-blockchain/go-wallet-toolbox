...
type Repository interface {
	...
	UpsertLabelForSync(ctx context.Context, entity *entity.TxLabel) (isNew bool, labelNumID uint, err error)
	DeleteLabelForSync(ctx context.Context, entity *entity.TxLabel) (deleted bool, err error)
	FindLabelsMapForSync(ctx context.Context, userID int, opts ...queryopts.Options) ([]*wdk.TableTxLabelMap, error)
	FindLabelByIDForSync(ctx context.Context, labelNumID uint) (*entity.TxLabel, error)
	DeleteLabelMapForSync(ctx context.Context, entity *entity.TxLabelsMap) (deleted bool, err error)
	UpsertLabelMapForSync(ctx context.Context, entity *entity.TxLabelsMap) (isNew bool, err error)

	FindTagsForSync(ctx context.Context, userID int, opts ...queryopts.Options) ([]*wdk.TableOutputTag, error)
	UpsertTagForSync(ctx context.Context, entity *entity.OutputTag) (isNew bool, tagNumID uint, err error)
	DeleteTagForSync(ctx context.Context, entity *entity.OutputTag) (deleted bool, err error)
	FindTagsMapForSync(ctx context.Context, userID int, opts ...queryopts.Options) ([]*wdk.TableOutputTagMap, error)
	FindTagByIDForSync(ctx context.Context, labelNumID uint) (*entity.OutputTag, error)
	DeleteTagMapForSync(ctx context.Context, entity *entity.OutputTagsMap) (deleted bool, err error)
	UpsertTagMapForSync(ctx context.Context, entity *entity.OutputTagsMap) (isNew bool, err error)
}
