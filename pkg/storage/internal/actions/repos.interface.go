...
type TransactionsRepo interface {
	CreateTransaction(ctx context.Context, transaction *entity2.NewTx) error
...
type ProvenTxRepo interface {
	UpsertProvenTxReq(ctx context.Context, req *entity2.UpsertProvenTxReq, historyNote string, historyAttrs map[string]any) error
