...
func (s *WalletTestSuite) Test_AcquireCertificate_IssuanceProtocol_Remote() {
	t := s.T()
	...
	args.CertifierUrl = "https://certify.bsvb.tech" // Use the test server URL
	args.Certifier, _ = ec.PublicKeyFromString("03c644fe2fd97673a5d86555a58587e7936390be6582ece262bc387014bcff6fe4")
