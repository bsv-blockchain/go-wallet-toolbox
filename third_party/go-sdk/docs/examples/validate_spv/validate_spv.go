...
func main() {
	...
	if err != nil {
		fmt.Println("Error decoding BEEF:", err) //nolint:forbidigo // example program output
		return
	}
	// Example usage
	...
	if err != nil {
		fmt.Println("Error creating transaction from BEEF:", err) //nolint:forbidigo // example program output
		return
	}

	root, err := tx.MerklePath.ComputeRoot(tx.TxID())
	if err != nil {
		fmt.Println("Error getting merkle root:", err) //nolint:forbidigo // example program output
		return
	}
	...
	if err != nil {
		fmt.Println("Error validating root for height:", err) //nolint:forbidigo // example program output
		return
	}
	fmt.Println("Is valid root for height:", valid) //nolint:forbidigo // example program output
}
