...
// Pass in your txID from the show_address_for_tx_from_faucet example
...
// Use the show_address_for_tx_from_faucet example to get the user address and follow the instructions to fund the address from the faucet
func main() {
